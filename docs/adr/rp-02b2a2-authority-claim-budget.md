...
- 同一 15-action fixture 逐项验证 HTTP `200`、两次 service authority snapshot 与 repository commit recheck、action/object/tenant/novel 绑定、`authoritySnapshotHash` 与 authoritative provider projection hash。
