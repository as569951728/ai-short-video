...
baseline_sha: 501a3cfcdf12341d9f611f0fdd6a6336d4ade483
hard_max_files: 18
...
硬预算为 `18 files / 1,900 net additions`。本包授权基线为 `501a3cfcdf12341d9f611f0fdd6a6336d4ade483`。实现提交必须在同一 diff 填入前一 clean commit、更新真实计数，并由生产 workflow 通过 PR merge-base、push before/head 或 manual 显式 SHA 调用真实 package gate 验证。
