...
| RMD-TASK-002 | PB/P0 | 请求内 await 长 provider，没有独立 worker、心跳和进程重启恢复 | partial | RP-02B1 `415d03a` 已通过；RP-02B2a0 `2da6d31` 已完成实现、TEST/QUALITY 双验收、远程四路 CI 和 clean checkout，风险参数同步前置门禁已闭合；B2a/B2b/B2c/B3 仍未授权，worker/restart E6 未实现 | DEV | RP-02B | TASK-WORKER-01, TASK-RESTART-01 |
