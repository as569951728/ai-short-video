...
| RMD-TASK-002 | PB/P0 | 请求内 await 长 provider，没有独立 worker、心跳和进程重启恢复 | partial | RP-02B1 `415d03a` 已通过；B2 已拆 B2a0/B2a/B2b/B2c，第十一轮四路准入均 approved 且 P0/P1/P2=0，现仅进入需求资产 commit/push 与远程治理；任何 B2 实现仍未授权，restart E6 未实现 | DEV | RP-02B | TASK-WORKER-01, TASK-RESTART-01 |
