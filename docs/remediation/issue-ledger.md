...
| RMD-TEST-FIXTURE-001 | QG/P0 | 缺 processing、timeout、脏 JSON、迟到结果、重复 current、分块失败和重启 fixture | closed | `dc1991a`；runs `29208828449`/`29208908909`；独立 TEST/QUALITY approved；关闭记录 | TEST + DEV | RP-01C | TEST-FIXTURE-01 |
