...
| RMD-TEST-EVIDENCE-001 | QG/P1 | 验收结论未强制分列 contract/unit/API/DB/browser/provider/media | partial | E0-E7 纠偏；历史“通过”口径 | TEST + MC | RP-00A | TEST-EVIDENCE-LEVEL-01 |
...
| RMD-GOV-STATUS-001 | QG/P1 | 当前状态、历史事件和追加式文档曾互相冲突，巡检口径滞后 | partial | main-control 与旧 heartbeat | MC + QUALITY | RP-00A | GOV-STATUS-01 |
...
| RMD-GOV-STAGE-001 | QG/P1 | 协作文档原先仍称“研发前设计阶段”，当前已修改为整改冻结期但尚未完成独立验收 | implemented_pending_verification | `docs/development-coordination.md` 当前 diff | MC | RP-00A | GOV-STAGE-01 |
