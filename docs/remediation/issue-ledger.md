...
| RMD-TASK-002 | PB/P0 | 请求内 await 长 provider，没有独立 worker、心跳和进程重启恢复 | partial | RP-02B1 `415d03a`：ExecutionEnvelope、lease/fencing/recovery 仓储原语 E3 已通过；dispatcher/HTTP 202/worker loop/restart E6 未实现 | DEV | RP-02B | TASK-WORKER-01, TASK-RESTART-01 |
