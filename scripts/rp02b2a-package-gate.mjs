...
export const PACKAGE_DEFINITIONS = {
  ...
  [CI_TRIGGER_SPLIT_ID]: definition(CI_TRIGGER_SPLIT_ID, 'RP-02B2a2-PM-C3-v1', CI_TRIGGER_SPLIT_ADR, 'test:rp02b2a1:gate', 4, 1200, `.github/workflows/rp01c-fixtures.yml|scripts/rp02b2a-package-gate.mjs|scripts/rp02b2a-package-gate.test.mjs|${CI_TRIGGER_SPLIT_ADR}`.split('|'), ['governance', 'test', 'adr']),
