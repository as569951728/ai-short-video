...
export const REPOSITORY_FLOW_POLICY = {
  ...
  events: [
    ...
    },
    {
      ...
      type: 'pull_request_merged',
      pullRequest: 58,
      mergeSha: 'b2b9dadbd3850f3f72ec6412f991367de91f9ca1',
      authorityEventId: 'MCE-20260802-GOV-STATUS-REGRESSION-CLOSED'
    },
    {
      id: 'pr-59-merged',
      type: 'pull_request_merged',
      pullRequest: 59,
      mergeSha: 'e3cdc9a2474750c28110e6b83b0e39a43bf80cb6',
      authorityEventId: 'MCE-20260802-GOV-STATUS-REGRESSION-CLOSED'
    },
    {
      id: 'ledger-closure-rmd-gov-status-001-2026-08-02',
      type: 'ledger_closure',
      authorityEventId: 'MCE-20260802-GOV-STATUS-REGRESSION-CLOSED',
    ...
    },
    {
      ...
      type: 'pull_request_merged',
      pullRequest: 63,
      mergeSha: '5e42d5f32de308dff4e3c9531aed428c815bd279',
      authorityEventId: 'MCE-20260803-RP04C-NOV-REVIEW-CLOSED'
    },
    {
      id: 'pr-64-merged',
      type: 'pull_request_merged',
      pullRequest: 64,
      mergeSha: 'f98f53245ce3382b93d10938e2d82d745031a4e4',
      authorityEventId: 'MCE-20260803-RP04C-NOV-REVIEW-CLOSED'
    },
    {
      id: 'ledger-closure-rmd-nov-review-001-2026-08-03',
      type: 'ledger_closure',
      authorityEventId: 'MCE-20260803-RP04C-NOV-REVIEW-CLOSED',
      issueId: 'RMD-NOV-REVIEW-001',
      closureHead: 'f98f53245ce3382b93d10938e2d82d745031a4e4',
      closedCountAfterEvent: 12
    }
  ]
};
